# Graph Report - MiniCPM-V-demo-Android  (2026-08-24)

## Corpus Check
- 322 files · ~136,456 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3472 nodes · 7053 edges · 249 communities (162 shown, 87 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 409 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d67a218d`
...
- CalibratedEvidenceAcceptancePolicy
...
- .resolve
- RetrievalThresholdCalibratorTest
...
## Communities (249 total, 87 thin omitted)

### Community 0 - "MainActivity"
Cohesion: 0.12
Nodes (12): ChatViewportAnchor, Bitmap, ImageView, Job, RecyclerView, TextInputEditText, TextView, View (+4 more)

### Community 1 - "ValueError"
Cohesion: 0.13
Nodes (36): _balanced(), build_balanced_rows(), _capped_documents(), _capped_prompts(), _clean(), _conversation_rows(), CorpusExample, _deduplicate_examples() (+28 more)
...
Cohesion: 0.31
Nodes (7): CurrentRetrievalCalibration, RetrievalCalibrationKey, RetrievalCalibrationProfile, RetrievalCalibrationMetrics, RetrievalCalibrationObservation, RetrievalCalibrationResult, RetrievalThresholdCalibrator
...
### Community 6 - "public_office_dataset.py"
Cohesion: 0.14
...
Cohesion: 0.09
Nodes (5): FileSource, ByteArray, LlamaEngine, RaceWinner, RuntimeException

### Community 8 - "MiniCPMApplication"
Cohesion: 0.09
Nodes (24): RagAllQueriesFlowInstrumentedTest, HybridRetrieverInstrumentedTest, MiniCPMApplication, RagDatabase, HnswVectorSearchBackend, DatabaseRagTurnStateSource, IdentityRagEvidenceReducer, LowLatencyRagRuntimeGate (+16 more)

### Community 9 - "PendingImageStateMachine.kt"
Cohesion: 0.14
Nodes (8): ChatInputControls, PendingImageCancellationDisplay, CLEARING, HIDDEN, PendingImageCancellationMode, CONTEXT_RESET, USER_REMOVE, PendingImageCancellationPolicy
...
Cohesion: 0.13
Nodes (6): Empty, PendingImageState, PendingImageStateMachine, Preprocessing, Ready, PendingImageStateMachineTest
...
Cohesion: 0.05
Nodes (27): DocumentStatus, CANCELLED, CHUNKING, COPYING, DELETING, EMBEDDING, FAILED, INDEXING (+19 more)
...
Cohesion: 0.12
Nodes (6): LongArray, RagGuardInput, RetrievedChunk, RagGuardInferenceContractTest, CitationValidatorTest, RagPromptAssemblerTest

### Community 20 - "RagTurnTransaction"
Cohesion: 0.13
Nodes (10): StateFlow, ModelHistoryRole, ASSISTANT, USER, NativeCheckpoint, EphemeralContextEngine, RagTurnTransaction, FakeEphemeralContextEngine (+2 more)

### Community 21 - "OoxmlSecurityTest"
Cohesion: 0.25
Nodes (3): DocxParser, ByteArray, OoxmlSecurityTest

### Community 22 - "VisitedListPool"
Cohesion: 0.16
...
Cohesion: 0.15
Nodes (6): EmbeddingCorpusKey, stableDigest(), HnswRebuildContract, HnswRebuildInput, WorkManagerHnswRebuildScheduler, HnswRebuildContractTest

### Community 31 - "GroundednessVerdict"
Cohesion: 0.11
Nodes (18): GroundednessVerdict, Accepted, ClassifierIdentityMismatchException, CurrentGroundednessCalibration, EmptyVisibleAnswerException, ExperimentalGroundednessCalibration, FallbackToNormalGeneration, GroundednessCalibrationProfile (+10 more)

### Community 32 - "Fixture"
Cohesion: 0.19
Nodes (3): RagEvidenceBudget, Fixture, RagCoordinatorTest

### Community 34 - "RagTempFileCleaner"
Cohesion: 0.12
Nodes (7): RagTempFileCleaner, Exception, ParserException, PdfPageSelection, CoroutineWorker, Result, ParseWorker
...
Cohesion: 0.10
Nodes (11): ChunkDao, ChunkFtsMatchInfoRow, EmbeddingCorpusStamp, ChunkEmbeddingEntity, ChunkEntity, E5InputKind, PASSAGE, QUERY (+3 more)
...
### Community 43 - "ChunkWorker.kt"
Cohesion: 0.23
Nodes (5): E5TokenizerRegistry, E5Tokenizer, ChunkWorker, CoroutineWorker, Result

### Community 44 - ".submitPromptToModel"
Cohesion: 0.20
Nodes (5): RagPromptTokenCounter, RagPromptTokenCounter, PendingPrivacyAction, RevealResponse, SubmitPrompt

### Community 45 - "HnswIndexMetadata.kt"
Cohesion: 0.13
Nodes (10): HnswIndexManager, HnswIndexAdmission, HnswIndexAdmissionPolicy, HnswIndexPathPolicy, HnswIndexRejection, CORPUS_MISMATCH, RSS_BUDGET_EXCEEDED, HnswIndexRssPolicy (+2 more)
...
Cohesion: 0.12
Nodes (12): ChatAdapter, ImageView, LinearProgressIndicator, MaterialButton, RecyclerView, TextView, View, ViewGroup (+4 more)

### Community 48 - "BlockStructure"
Cohesion: 0.15
...
Cohesion: 0.33
Nodes (3): RagRouteInput, RagQueryRouterTest, RouteCase
...
Cohesion: 0.19
Nodes (4): Context, Context, ModelInfo, SharedPreferences
...
### Community 56 - "TtsEngine"
Cohesion: 0.15
Nodes (10): Error, Generating, Initializing, Context, StateFlow, LoadingModel, Ready, TtsEngine (+2 more)

### Community 57 - "ParserInput"
Cohesion: 0.10
Nodes (9): CsvParser, DocumentParser, ParserInput, HtmlParser, MarkdownParser, ParserRegistry, TextParser, BasicParserTest (+1 more)
...
### Community 60 - "OcrWorker"
Cohesion: 0.31
Nodes (5): CoroutineWorker, Result, T, OcrWorker, java

### Community 61 - "PdfOcrInstrumentedTest"
Cohesion: 0.23
...
### Community 67 - ".decode"
Cohesion: 0.29
Nodes (5): DigestResult, hexToBytes(), HnswIndexIntegrity, HnswIndexMetadataCodec, ByteArray
...
Cohesion: 0.11
Nodes (43): canonical_existing_directory(), jint, jlong, JNIEnv, JNIEXPORT, jobject, jstring, Result (+35 more)
...
### Community 79 - "FileOutputStream"
Cohesion: 0.18
Nodes (6): CachedImageSource, ImageSourceCache, ImageSourceTooLargeException, ImageSourceUnreadableException, ImageSourceCacheTest, FileOutputStream
...
Cohesion: 0.18
Nodes (6): AutoCloseable, FloatArray, RagGuardClassifier, OnnxRagGuardClassifier, AutoCloseable, RagGuardModelManager

### Community 86 - "RagEvidenceAcceptancePolicy"
Cohesion: 0.25
...
Cohesion: 0.22
Nodes (5): BoundedXmlHandler, Attributes, ByteArray, SafeOoxmlReader, DefaultHandler

### Community 88 - ".benchmarkScale"
Cohesion: 0.06
Nodes (19): ConsumerProbeException, FailingInputStream, ByteArray, Context, RagEncryptionTest, HnswRun, HnswScaleBenchmarkInstrumentedTest, FloatArray (+11 more)
...
Cohesion: 0.09
Nodes (20): BaseMultiVectorSpace, get_doc_id, set_doc_id, EpsilonSearchStopCondition, curr_num_items_, epsilon_, max_num_candidates_, min_num_candidates_ (+12 more)
...
### Community 101 - "HnswFallbackReason"
Cohesion: 0.19
...
### Community 104 - "fail"
Cohesion: 0.10
Nodes (19): RagLimits, fail(), ParserError, CANCELLED, INVALID_ENCODING, MALFORMED_DOCUMENT, OCR_FAILED, PDF_CORRUPT (+11 more)
...
### Community 111 - "ActivityLifecycleCallbacks"
Cohesion: 0.23
...
### Community 119 - "HnswIndexMetadata"
Cohesion: 0.28
Nodes (3): HnswIndexMetadata, HnswIndexPaths, T

### Community 120 - ".maskedMeanAndNormalize"
Cohesion: 0.47
Nodes (3): E5Pooling, FloatArray, LongArray

### Community 121 - "RoomDenseEvidenceRetriever.kt"
Cohesion: 0.14
Nodes (12): CountingSource, FakeFallback, Fixture, HnswCorpusSource, HnswVectorSearchBackendInstrumentedTest, Fixture, HnswCorpusSource, VectorEmbeddingSource (+4 more)
...
### Community 123 - "SyntheticOfficeCalibrationCorpus.kt"
Cohesion: 0.26
Nodes (5): SyntheticCalibrationCase, SyntheticCalibrationCorpus, SyntheticCalibrationDocument, SyntheticOfficeCalibrationCorpus, CjkBigramEncoder

### Community 124 - "KnowledgeBaseAdapter.kt"
Cohesion: 0.12
Nodes (12): KnowledgeBaseAdapter, KnowledgeBaseListItem, TextView, View, ViewGroup, HorizontalSwipeDismissPolicy, Failure, KnowledgeBaseDocumentPresentation (+4 more)
...
Cohesion: 0.12
Nodes (12): DISTFUNC, MultiVectorInnerProductSpace, data_size_, dim_, fstdistfunc_, vector_size_, MultiVectorL2Space, data_size_ (+4 more)
...
### Community 145 - ".build"
Cohesion: 0.13
Nodes (14): BelowThreshold, HnswCorpusSource, HnswIndexBuilder, HnswIndexBuildOutcome, Published, StaleCorpus, HnswRebuildRunner, HnswCorpusSource (+6 more)
...
Cohesion: 0.21
Nodes (7): HnswIndexPublicationInstrumentedTest, EncryptedFileStore, E5ModelSpec, FloatVectorCodec, ByteArray, FloatArray, HnswIndexPublisher
...
### Community 177 - "RankedChunkId"
Cohesion: 0.14
Nodes (9): ExactVectorBuffer, ExactVectorBufferCache, FloatArray, PartitionedExactVectorRanker, ExactVectorRanker, FloatArray, RankedChunkId, VectorCandidate (+1 more)
...
### Community 203 - "AudioRecorder"
Cohesion: 0.33
Nodes (3): AudioRecorder, ByteArray, AudioRecord

### Community 204 - "OriginalImageViewerActivity.kt"
Cohesion: 0.29
...
### Community 216 - "StatusBarVisibleActivity"
Cohesion: 0.25
...
### Community 238 - "FinalizeIndexWorker.kt"
Cohesion: 0.50
...
## Knowledge Gaps
- **376 isolated node(s):** `BUILD`, `MID_PAYLOAD_ENCRYPTION`, `AFTER_PAYLOAD_PUBLISH`, `AFTER_METADATA_PUBLISH`, `RELEVANT` (+371 more)
...
- **Why does `MainActivity` connect `MainActivity` to `LlamaEngine`, `PendingImageViewModel`, `MainActivityUiTest`, `.clearChatUI`, `LlamaState`, `ConversationStore`, `.submitPromptToModel`, `ChatAdapter`, `CitationRef`, `ConversationArchive`, `ChatMessage`, `OriginalImageViewerActivity.kt`, `FileOutputStream`, `.refreshInputControls`, `StatusBarVisibleActivity`, `.submitMessages`, `.onCreate`, `.showChatSettingsDialog`, `RagTurnLifecycleInstrumentedTest`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `RetrievedChunk` connect `RetrievedChunk` to `MainActivity`, `EvidenceReducerTest`, `ExactAnchorMatcherTest`, `RagVisualGroundingPolicyTest`, `RetrievalCalibrationKey`, `MiniCPMApplication`, `RagEndToEndPerformanceInstrumentedTest`, `HybridRetriever`, `GroundednessVerdict`, `Fixture`, `RagGuardInstrumentedTest`, `VisualResponseDecision`, `AnswerabilityVerdict`, `AnswerabilityClassifier`, `.plan`, `RagTokenBudgetInstrumentedTest.kt`, `RagGuardClassifier.kt`, `RagContextBudgeter`, `RagPromptAssembler`, `OnnxRagGuardClassifier`, `RagEvidenceAcceptancePolicy`, `GroundednessReleaseMatrixInstrumentedTest`, `RagQueryRoute`, `LazyAnswerabilityClassifier`, `RetrievalThresholdCalibratorTest`, `SentenceWindowEvidenceReducer`, `CalibratedEvidenceAcceptancePolicy`, `ExactAnchorMatcher`, `CitationValidator`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Why does `LlamaEngine` connect `LlamaEngine` to `MainActivity`, `.readyEngine`, `LlamaVisualCheckpointInstrumentedTest`, `RagTokenBudgetInstrumentedTest.kt`, `VisualPromptDecision`, `VisualResponseDecision`, `RagEndToEndPerformanceInstrumentedTest`, `.nativeContextDebugSnapshot`, `VisualContextPolicy`, `ModelManagerActivity`, `RagTurnLifecycleInstrumentedTest`, `.sendPrompt`, `RagTurnTransaction`, `Context`, `.benchmarkScale`, `LlamaCheckpointInstrumentedTest`, `LlamaState`?**
